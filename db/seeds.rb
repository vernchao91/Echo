...
conversation1 = Conversation.create!(owner_id: 2, user_id: 3, owner_username: demo.username, user_username: ashe.username)
conversation2 = Conversation.create!(owner_id: 4, user_id: 2, owner_username: alistar.username, user_username: demo.username)
conversation3 = Conversation.create!(owner_id: 5, user_id: 4, owner_username: ryze.username, user_username: alistar.username)
conversation4 = Conversation.create!(owner_id: 5, user_id: 6, owner_username: ryze.username, user_username: wraith.username)
conversation5 = Conversation.create!(owner_id: 6, user_id: 7, owner_username: wraith.username, user_username: pathfinder.username)
conversation6 = Conversation.create!(owner_id: 7, user_id: 5, owner_username: pathfinder.username, user_username: ryze.username)