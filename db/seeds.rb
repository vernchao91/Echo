...
message12 = Message.create!(body: "anyone ARAM", author_id: 7, messageable_id: channel4.id, messageable_type: "Channel")
message13 = Message.create!(body: "im in!", author_id: 8, messageable_id: channel4.id, messageable_type: "Channel")
message14 = Message.create!(body: "count me in", author_id: 16, messageable_id: channel4.id, messageable_type: "Channel")
message15 = Message.create!(body: "i can play!", author_id: 9, messageable_id: channel4.id, messageable_type: "Channel")
message16 = Message.create!(body: "one more spot left!", author_id: 7, messageable_id: channel4.id, messageable_type: "Channel")
message17 = Message.create!(body: "i can play 1 game!", author_id: 13, messageable_id: channel4.id, messageable_type: "Channel")
